...
class RecRoIHead(BaseRoIHead):
    ...
    This code is from https://github.com/open-mmlab/mmocr."""
    ...
    def loss(self, inputs: Tuple[Tensor], data_samples: DetSampleList) -> dict:
        ...
        for ds in data_samples:
            ignored = ds.gt_instances.ignored
            if hasattr(ds.gt_instances, 'text_ignored'):
                ignored = ignored | ds.gt_instances.text_ignored
            proposals.append(ds.gt_instances[~ignored])
